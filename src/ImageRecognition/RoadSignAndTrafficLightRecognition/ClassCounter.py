#Alex Eliseev
#Simple script goes through the data/train folder and simply counts the quantity of each class in the training pool.
...
LABELS_DIR = PROJECT_ROOT / "Data" / "SignAndTrafficLights" / "train" / "labels"
